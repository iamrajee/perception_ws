...
if mesh_path_env_name in os.environ:
  ...
  catkin_ws_path = os.path.expanduser('~') + '/swarm_ws/src/'
...
def find_model_in_gazebo_dir(modelname):
  ...
  # print("debug find_model_in_gazebo_dir.cache:",find_model_in_gazebo_dir.cache)
  ...
  if '/' in modelname:  # path-based
    for models_path in models_paths + ['.']:
      ...
      for modelfile_path in modelfile_paths:
        # print("debug modelfile_path:",modelfile_path)
